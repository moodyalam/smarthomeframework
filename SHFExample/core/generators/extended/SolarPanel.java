...
public class SolarPanel extends AbstractGenerator implements IRenewableGenerator{
	...
	public SolarPanel(String name, double maxGenCapacity)
	{
		super(name, maxGenCapacity);
		DataLoader dataLoader = new DataLoader(Config.PathToSolarDataFile);
