...
public class MaxUtilOptModelCostIncluded_ER extends MaxUtilOptModelCostIncluded{

	public MaxUtilOptModelCostIncluded_ER(String optID, MyAgent agent) throws IloException {
		super(optID, agent);
	}
	
	public MaxUtilOptModelCostIncluded_ER(String optID, MyAgent agent, IloCplex cplex) throws IloException {	
	...
	{	
		...
		{
			System.err.println("Exchange relatd optimisation can only be carried out with agent link flow set to Connected");
