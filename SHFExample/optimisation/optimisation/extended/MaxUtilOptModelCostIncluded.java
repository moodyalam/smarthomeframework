...
public class MaxUtilOptModelCostIncluded extends AbstractOptModel{

	private static final int timeslots = Config.timeslots;
	
	public MaxUtilOptModelCostIncluded(String optID, MyAgent agent) throws IloException {	
		super(optID, agent);		
	}
	
	public MaxUtilOptModelCostIncluded(String optID, MyAgent agent, IloCplex cplex) throws IloException {	
	...
	public IloObjective getObjectiveFunction() throws IloException
	{
		...
		IloNumExpr ua = prepareUtilityFunction();
	...
	public IloNumExpr prepareUtilityFunction() throws IloException
	{
		return prepareUtilityFunctionForAgent(cplex, agent, baseLoad, waste, 
